...
export default function ExchangePageClient(){
  ...
  const [points,setPoints]=useState(dashboard.session.points);const [cards,setCards]=useState<Card[]>([]);const [busy,setBusy]=useState("");const [notice,setNotice]=useState("");
